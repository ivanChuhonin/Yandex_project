...
Модульная версия [исходного ноутбука](https://github.com/ivanChuhonin/Yandex_project) — с исправленными багами, единой логикой разметки тональности и воспроизводимым пайплайном.
